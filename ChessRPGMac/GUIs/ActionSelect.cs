...
namespace ChessRPGMac
{
    public class ActionSelect : GUIGroup, ISelectable
    {
        ...
        public ActionSelect(string name, GUIComponent parent, int rx, int ry, Skill[] skills)
        ...
        public void SetActions(Skill[] skills)
        {
            this.skills = skills;
            index = 0;
        }
        ...
        public void SelectAction()
        {
            ...
            {
                ((BattleState)Global.state).TargetSelectEnable(skills[index]);
            }
        }
